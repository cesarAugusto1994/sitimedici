              ...
              <div class="col-lg-12 col-md-12">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Nome</label>
                      <div class="col-sm-10">
                        <input type="text" name="nome" required class="form-control" value="{{ $evento->nome }}">
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Data</label>
                      <div class="col-sm-10">
                        <input type="text" name="data" data-mask="99/99/9999" value="{{ $evento->data->format('d/m/Y') }}" required class="form-control datepicker">
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Conteúdo</label>
                      <div class="col-sm-10">
                        <textarea id="summernote" required rows="7" name="conteudo">{{ $evento->conteudo }}</textarea>
                      </div>
                  </div>
                    ...
                    <div class="col-sm-10">
                      <div class="fileinput fileinput-new" data-provides="fileinput">
                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                          <img data-src="holder.js/300x200" @if($evento->imagem) src="/{{ $evento->imagem }}"  @endif alt="...">
                        </div>
                        <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px;"></div>
                        <div>
                          <span class="btn btn-default btn-block btn-file"><span class="fileinput-new">Selecionar Imagem</span>
                          <span class="fileinput-exists">Trocar</span><input type="file" name="imagem"></span>

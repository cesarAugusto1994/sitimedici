...
@section('content')
    <div class="box box-default">
        ...
        <div class="box-body">
          ...
          <form method="post" enctype="multipart/form-data" id="formPagina" class="form-horizontal" action="{{route('pagina_store')}}">
          {{csrf_field()}}
              ...
              <div class="col-lg-12 col-md-12">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Link</label>
                      <div class="col-sm-10">
                        <input type="text" name="url" required class="form-control" value="">
                      </div>
                  </div>
